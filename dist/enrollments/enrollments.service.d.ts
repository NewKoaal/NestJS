...
export declare class EnrollmentsService {
    ...
    constructor(enrollmentRepo: Repository<Enrollment>, requestRepo: Repository<EnrollmentRequest>, inviteRepo: Repository<CourseInvitation>, courseRepo: Repository<Course>, userRepo: Repository<User>);
    ...
    acceptInvitation(userId: string, userEmail: string, code: string): Promise<Enrollment>;
